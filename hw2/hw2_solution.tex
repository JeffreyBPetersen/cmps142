...
\begin{enumerate}
		...
		$$
				...
				-0.0149
       			 \end{bmatrix}
  		$$
		Out of 768 patients, 500 didn't have diabetes thus our
		$$bias\ = \frac{500}{768} = 0.651$$\\
		Therefore the equation for our decision boundary is: 
		$$\Sigma_i \ a_i * x_i \ + \ 0.651\ = \ 0$$
	     \\\\
                \item
                    \begin{tabular}{l | c c c c c c}
                        Algorithm      & Correct & Incorrect & MAE & RMS & RAE (\%) & RSE (\%)\\
